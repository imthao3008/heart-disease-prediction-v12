...
def preprocess_input(user_input, imp_num, imp_cat, scaler, num_cols, other_cols, all_columns):
    ...
    # Missing Indicator Flags (giống pipeline train)
    # Nếu người dùng chọn "Không thực hiện" → giá trị None → flag = 1
    ...
    # Impute (người dùng nhập đủ → chủ yếu để xử lý cột OHE thiếu)
